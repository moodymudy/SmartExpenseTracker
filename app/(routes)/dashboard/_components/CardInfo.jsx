        ...
        {budgetList?.length > 0 ? (
            <div className='mt-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                <div className='p-7 border rounded-lg flex items-center justify-between'>
                    <div>
                        <h2 className='font-sans text-sm'>Total Budget</h2>
                        <h2 className='font-sans font-bold text-2xl'>${totalBudget}</h2> 
                    </div>
                    <PiggyBank className='bg-blue-500 p-3 h-12 w-12 rounded-full text-white' />
                </div>
                <div className='p-7 border rounded-lg flex items-center justify-between'>
                    <div>
                        <h2 className='font-sans text-sm'>Total Spend</h2>
                        <h2 className='font-sans font-bold text-2xl'>${totalSpend}</h2> 
                    </div>
                    <ReceiptText className='bg-blue-500 p-3 h-12 w-12 rounded-full text-white' />
                </div>
                <div className='p-7 border rounded-lg flex items-center justify-between'>
                    <div>
                        <h2 className='font-sans text-sm'>No. of Budgets</h2>
                        <h2 className='font-sans font-bold text-2xl'>{budgetList?.length}</h2> 
                    </div>
